...
const Navigation = ({ activeTab, setActiveTab }) => {
  ...
  const tabs = [
    ...
    {
      id: "outofstock",
      name: `Produits Epuise (${outOfStockProducts.length})`,
      icon: (
  ...
  return (
    <nav className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-4">
      <div className="flex flex-wrap items-center justify-start gap-1 p-1">
        {tabs.map((tab) => (
          <button
            key={tab.id}
